...
class Sfp(SfpBase):
    ...
    """
    Target platform-specific Sfp class
    """
    ...
    PLATFORM = "arm64-target_tg48m-p_52x-r0"
    HWSKU = "tg48m-p"
    ...
    def get_rx_los(self):
        ...
        if smbus_present == 0:
            ...
            cmdstatus, rxlosstatus = cmd.getstatusoutput('i2cget -y 0 0x41 0x40')
    ...
    def get_tx_disable(self):
        ...
        if smbus_present == 0:
            cmdstatus, disstatus = cmd.getstatusoutput('i2cget -y 0 0x41 0x31')
    ...
    def reset(self):
        ...
        path = "/sys/class/i2c-adapter/i2c-{1}/{0}-0050/sfp_port_reset"
    ...
    def get_presence(self):
        ...
        if smbus_present == 0:  # if called from sfputil outside of pmon
            cmdstatus, sfpstatus = cmd.getstatusoutput('i2cget -y 0 0x41 0x3a')
