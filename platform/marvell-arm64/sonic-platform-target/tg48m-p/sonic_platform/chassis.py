...
# Device counts
MAX_TG48M-P_FAN_DRAWER = 1
MAX_TG48M-P_FAN = 3
MAX_TG48M-P_PSU = 2
MAX_TG48M-P_THERMAL = 6

# Temp - disable these to help with early debug
MAX_TG48M-P_COMPONENT = 2
...
class Chassis(ChassisBase):
    """
    Target platform-specific Chassis class
        Derived from Dell S6000 platform.
        customized for the TG48M-P platform.
    """
    ...
    def __init__(self):
        ...
        drawer_num = MAX_TG48M-P_FAN_DRAWER
        fan_num_per_drawer = MAX_TG48M-P_FAN
        ...
        for i in range(MAX_TG48M-P_PSU):
            psu = Psu(i)
            self._psu_list.append(psu)

        for i in range(MAX_TG48M-P_THERMAL):
            thermal = Thermal(i)
            self._thermal_list.append(thermal)

        for i in range(MAX_TG48M-P_COMPONENT):
